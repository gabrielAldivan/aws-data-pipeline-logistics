...
class TestSilverTransformations:
    ...
    def test_cast_types_uppercases_string_cols(self, spark):
        ...
        df = spark.createDataFrame([{
            ...
            "cargo_weight_tons": "1000", "freight_value_brl": "50000",
            "fuel_cost_brl": "5000", "delay_minutes": "0",
            "cargo_type":          "grain",
            "origin_station":      " santos ",
    ...
    def test_dq_rules_quarantine_negative_weight(self, spark):
        ...
        rows = [
            {"trip_id": "OK-1",  "cargo_weight_tons": 1000.0,
             "freight_value_brl": 50000.0, "delay_minutes": 0,
             "departure_time": "2024-01-01 06:00:00", "arrival_time": "2024-01-01 12:00:00"},
            {"trip_id": "BAD-1", "cargo_weight_tons": -1.0,
             "freight_value_brl": 50000.0, "delay_minutes": 0,
             "departure_time": "2024-01-01 06:00:00", "arrival_time": "2024-01-01 12:00:00"},
        ]
...
class TestGoldAggregations:
    ...
    def test_cargo_mix_revenue_shares_sum_to_100_per_date(self, spark):
        ...
        for row in sums:
            assert abs(row["total_pct"] - 100.0) < 2.0, \
    ...
    def test_operator_ranking_columns_present(self, spark):
        ...
        expected = {"operator", "trip_date", "total_trips",
                    "total_revenue_brl", "on_time_rate_pct"}
